...
public class Consumers {
    ...
    public ConsumerRecord<String, String> getMessageFromQueue() throws InterruptedException {

        String uuid = (String) httpSession.getAttribute("userUUID");

        logger.info("Get UUID : {}", httpSession.getAttribute("userUUID"));
    ...
    public void eraseSessionInMessageQueue() {
        String uuid = (String) httpSession.getAttribute("userUUID");
